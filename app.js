...
"rating":{"rate":3.6,
    ...
    const display = () => {
        ...
        const CardDisplay = data.map((v)=>{

            return ` <div class="container-fluid row g-4 py-5 row-cols-1 row-cols-lg-3" id="products">
            <div class="card h-100 w-auto" style="width: 8rem;">
            <div>
                <img src="${v.image}" class="card-img-top w-100 " alt="...">
                </div>
                <div class="card-body">
        ...
        document.getElementById('products').innerHTML = CardDisplay.join(' ');
    }
    display();
